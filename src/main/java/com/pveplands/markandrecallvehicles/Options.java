...
public class Options {
    private static final Logger logger = Logger.getLogger(MarkAndRecallVehicles.getLoggerName(Options.class));
    ...
    private float minUsableQualityForVehicle = 65f;
    ...
    public void load(Properties properties) {
        ...
        minUsableQualityForVehicle = limit(minUsableQualityForVehicle, 0f, 100f);
    ...
    public float getMinUsableQualityForVehicle() {
        return minUsableQualityForVehicle;
    }
    ...
    public void setMinUsableQualityForVehicle(float minUsableQualityForVehicle){
        this.minUsableQualityForVehicle = minUsableQualityForVehicle;
    }
