...
public class MarkAndRecallVehicles implements WurmServerMod, ServerStartedListener, PreInitable, ItemTemplatesCreatedListener, Configurable { 
    private final static Logger logger = Logger.getLogger(getLoggerName(MarkAndRecallVehicles.class));
    ...
    public void configure(Properties properties) {
        ...
        options = new Options(properties, MarkAndRecallVehicles.class);
    }
    ...
    public void onServerStarted() {
        ...
        CreationEntryCreator.createSimpleEntry(options.getCraftSkill(), ItemList.stoneChisel, ItemList.marbleBrick, MarkAndRecallVehicles.getRuneTemplateId(),
